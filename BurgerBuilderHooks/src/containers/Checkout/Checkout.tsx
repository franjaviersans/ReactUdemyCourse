...
const checkout: React.FunctionComponent<RouteComponentProps> = (props) => {
  ...
  const checkoutContinuedHandler = () => {
    if (!props.history.location.pathname.includes("checkout/contact-data")) props.history.replace("checkout/contact-data");
  };
  ...
  if (ingredients) {
    ...
    summary = (
      <div>
        {purchasedRedirect}
        <CheckoutSummary ingredients={ingredients} checkoutCancelled={checkoutCancelledHandler} checkoutContinued={checkoutContinuedHandler} />
