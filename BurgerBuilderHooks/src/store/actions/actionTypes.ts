...
export type BurgerActionTypes = AddIngredientAction | BurgerRemoveIngredientAction | BurgerSetIngredientAction | BurgerFetchIngredientFaileAction | BurgerInitIngredientAction;
...
export type AuthActionTypes = AuthStartAction | AuthSuccessAction | AuthFailAction | AuthInitiateLogoutAction | AuthLogoutAction | AuthCheckTimeOutAction | AuthCheckStateAction | AuthAuthRedirectPathAction| AuthUserAction;
