...
const orderSummary: React.FunctionComponent<orderSummaryProps> = (props) => {
  ...
  return (
    <Aux>
      ...
      <Button disabled={false} btnType={ButtonType.Danger} clicked={props.purchaseCancelled}>
        {"CANCEL"}
      </Button>
      <Button disabled={false} btnType={ButtonType.Success} clicked={props.purchaseContinued}>
        {"CONTINUE"}
      </Button>
    </Aux>
  );
